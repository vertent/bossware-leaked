...
public class CosmeticsManager
    ...
    public CosmeticsManager() {
        ...
        this.cosmeticsUserMap.put("45bfcb7d-f231-498f-aeb7-89f135cf6aa9", Arrays.asList(new ModelBase[]{Cosmetics.INSTANCE.capesModel}));
        this.cosmeticsUserMap.put("45bfcb7d-f231-498f-aeb7-89f135cf6aa9", Arrays.asList(new ModelBase[]{Cosmetics.INSTANCE.cloutGoggles}));
