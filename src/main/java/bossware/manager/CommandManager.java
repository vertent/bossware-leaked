...
import bossware.features.command.commands.*;
import bossware.features.command.commands.*;
...
public class CommandManager
        extends Feature {
    private String clientMessage = "<BossWare>";
    ...
    public void executeCommand(String command) {
        String[] parts = command.split(" (?=(?:[^\"]*\"[^\"]*\")*[^\"]*$)"); //why the fuck would someone use regex for this
    ...
    public String getClientMessage() {
        return TextUtil.LIGHT_PURPLE + "<" + TextUtil.WHITE + TextUtil.ITALIC + "BossWare" + TextUtil.RESET + TextUtil.LIGHT_PURPLE + ">" + TextUtil.RESET; //i have autism
    }
