...
public class DiscordPresence {
    ...
    public static void start() {
        ...
        rpc.Discord_Initialize("896772965864198215", handlers, true, "");
        ...
        DiscordPresence.presence.largeImageKey = "bossware";
        DiscordPresence.presence.largeImageText = "BossWare - Beta";
