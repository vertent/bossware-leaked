...
public class BlockUtil
    ...
    public static boolean placeBlockSmartRotate(BlockPos pos, EnumHand hand, boolean rotate, boolean packet, boolean isSneaking) {
        ...
        if (rotate) {
            BossWare.rotationManager.lookAtVec3d(hitVec);
        }
        BlockUtil.rightClickBlock(neighbour, hitVec, hand, opposite, packet);
        BlockUtil.mc.player.swingArm(EnumHand.MAIN_HAND);
        BlockUtil.mc.rightClickDelayTimer = 4;
    ...
    public static boolean isInHole(Entity entity) {
        ...
        if(blockState.getBlock() == Blocks.ENDER_CHEST) blockPos = blockPos.up();
        ...
        for (BlockPos pos : BlockUtil.getTouchingBlocks(blockPos)) {
            ...
            if (touchingState.getBlock() != Blocks.AIR && (touchingState.getBlock() == Blocks.BEDROCK || touchingState.getBlock() == Blocks.OBSIDIAN ||
                    touchingState.getBlock() == Blocks.ENDER_CHEST))
                continue;
            return false;
        }
        return true;
    ...
    public static boolean isBlockValid(IBlockState blockState, BlockPos blockPos) {
        ...
        return BlockUtil.isBedrockHole(blockPos) || BlockUtil.isObbyHole(blockPos) || BlockUtil.isHole(blockPos) || BlockUtil.isElseHole(blockPos);
    }
    ...
    public static BlockPos[] getSurroundingBlocks(BlockPos blockPos) {
        return new BlockPos[]{blockPos.north(), blockPos.south(), blockPos.east(), blockPos.west()};
    }
}
