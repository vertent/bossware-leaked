        ...
        if (this.mode.getValue() == Mode.DAMAGE) {
            if (this.format.getValue() == Format.DAMAGE) {
                if (event.getStage() == 0) {
                    ...
                    if (Flight.mc.player.onGround) {
                        ...
                        BossWare.positionManager.setPlayerPosition(Flight.mc.player.posX, Flight.mc.player.motionY, Flight.mc.player.posZ);
            ...
            if (this.format.getValue() == Format.NORMAL) {
                ...
                if (this.noKick.getValue().booleanValue() && Flight.mc.player.ticksExisted % 5 == 0) {
                    BossWare.positionManager.setPlayerPosition(Flight.mc.player.posX, Flight.mc.player.posY - 0.03125, Flight.mc.player.posZ, true);
                }
