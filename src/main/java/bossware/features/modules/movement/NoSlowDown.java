...
import bossware.event.events.KeyEvent;
...
public class NoSlowDown
    ...
    public void onUpdate() {
        ...
        if (this.webs.getValue().booleanValue() && BossWare.moduleManager.getModuleByClass(Flight.class).isDisabled() && BossWare.moduleManager.getModuleByClass(Phase.class).isDisabled() && NoSlowDown.mc.player.isInWeb) {
