...
import bossware.util.ReflectionUtil;
...
public class XCarry
    ...
    public void onUpdate() {
        if (this.shiftClicker.getValue().booleanValue() && XCarry.mc.currentScreen instanceof GuiInventory) {
            Slot slot;
            boolean ourBind;
            boolean bl = ourBind = this.keyBind.getValue().getBind() != -1 && Keyboard.isKeyDown(this.keyBind.getValue().getBind()) && !Keyboard.isKeyDown(42);
    ...
    public void onKeyInput(InputEvent.KeyInputEvent event) {
        if (Keyboard.getEventKeyState() && !(XCarry.mc.currentScreen instanceof PhobosGui) && this.autoStore.getValue().getBind() == Keyboard.getEventKey()) {
            this.autoDuelOn = !this.autoDuelOn;
            Command.sendMessage("<XCarry> \u00a7aAutostoring...");
        }
    }
