...
public class BlockTweaks
    ...
    public void onPacketSend(PacketEvent.Send event) {
        ...
        if (this.noFriendAttack.getValue().booleanValue() && event.getPacket() instanceof CPacketUseEntity && (entity = (packet = event.getPacket()).getEntityFromWorld(BlockTweaks.mc.world)) != null && BossWare.friendManager.isFriend(entity.getName())) {
