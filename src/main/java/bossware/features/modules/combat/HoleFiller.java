...
public class HoleFiller
    ...
    private void doHoleFill() {
        ...
        if (this.midSafeHoles.getValue().booleanValue()) {
            object = BossWare.holeManager.getMidSafety();
            synchronized (object) {
                targets = new ArrayList<BlockPos>(BossWare.holeManager.getMidSafety());
            }
        }
        object = BossWare.holeManager.getHoles();
        synchronized (object) {
            targets = new ArrayList<BlockPos>(BossWare.holeManager.getHoles());
        }
    ...
    private boolean check() {
        ...
        this.switchItem(true);
        if (!this.freecam.getValue().booleanValue() && BossWare.moduleManager.isModuleEnabled(Freecam.class)) {
            return true;
        }
