...
public class Managers
    ...
    public Setting<String> command = this.register(new Setting<String>("Command", "Sushi.cc"));
    ...
    @Override
    public void onLoad() {
        BossWare.commandManager.setClientMessage(this.getCommandMessage());
    }
        ...
        if (event.getStage() == 2) {
            ...
            if (event.getSetting() != null && this.equals(event.getSetting().getFeature())) {
                if (event.getSetting().equals(this.holeThread)) {
                    BossWare.holeManager.settingChanged();
                }
                BossWare.commandManager.setClientMessage(this.getCommandMessage());
            }
        }
