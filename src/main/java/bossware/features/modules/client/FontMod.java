...
public class FontMod
    ...
    public Setting<Boolean> bold = this.register(new Setting<Boolean>("Bold", false));
    public Setting<Boolean> italic = this.register(new Setting<Boolean>("Italic", false));
    ...
    public void onTick() {
        ...
        if (this.reloadFont) {
            BossWare.textManager.init(false);
