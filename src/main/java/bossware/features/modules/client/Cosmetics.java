...
public class Cosmetics
    ...
    private final ResourceLocation capeTexture = new ResourceLocation("textures/sushicape.png");
    ...
    public void onRenderPlayer(RenderPlayerEvent.Post event) {
        if (!BossWare.cosmeticsManager.hasCosmetics(event.getEntityPlayer()) || EntityUtil.isFakePlayer(event.getEntityPlayer())) {
            return;
        }
        for (ModelBase model : BossWare.cosmeticsManager.getRenderModels(event.getEntityPlayer())) {
