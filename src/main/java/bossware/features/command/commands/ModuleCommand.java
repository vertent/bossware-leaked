...
import bossware.manager.ConfigManager;
...
public class ModuleCommand
    ...
    public void execute(String[] commands) {
        ...
        if (commands.length == 1) {
            ...
            for (Module.Category category : BossWare.moduleManager.getCategories()) {
                String modules = category.getName() + ": ";
                for (Module module : BossWare.moduleManager.getModulesByCategory(category)) {
        ...
        Module module = BossWare.moduleManager.getModuleByDisplayName(commands[0]);
        if (module == null) {
            module = BossWare.moduleManager.getModuleByName(commands[0]);
            if (module == null) {
